...
def get_model_save_data(q_network):
    return copy.deepcopy(q_network.state_dict())
...
if __name__ == "__main__":
        ...
        if "final_info" in infos:
            ...
            if args.save_model:
                ...
                if insert_index is not None:
                    model_data = get_model_save_data(q_network)
    ...
    if args.save_model:
        final_model_data = get_model_save_data(q_network)
        save_all_models(
